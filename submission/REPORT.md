...
- Thành viên và vai trò:
  - Phạm Quốc Tuấn (2A202601983) — GitHub [phamquoctuan2308](https://github.com/phamquoctuan2308) — Vai A: Logging & Middleware (branch `2a202601983-PhamQuocTuan`)
  - Trần Văn Hiếu (2A202602030) — GitHub [Marvis12957](https://github.com/Marvis12957) — Vai B: Security & Compliance / PII (branch `hieu`)
  - Trương Công Thái Đức (2A202601581) — GitHub [TruongDuke](https://github.com/TruongDuke) — Vai C: Metrics, Tracing & Alerting (branch `2A202601581-ThaiDuc`)
  - Trần Trung Hiếu (2A202602002) — GitHub [trunghieunef](https://github.com/trunghieunef) — Vai D: QA, Incident & Điều phối
